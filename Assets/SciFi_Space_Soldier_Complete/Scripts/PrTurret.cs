                ...
                foreach (GameObject p in playerGO)
                {
                    if (p != null)
                    {
                        if (p.GetComponent<PrActorUtils>())
                            enemyDead = p.GetComponent<PrActorUtils>().character.isDead;
                    ...
                    /*else if (p.GetComponent<PrAIController>())
                        enemyDead = p.GetComponent<PrAIController>().character.isDead;*/
    ...
    public void OnDrawGizmos()
    {
        ...
        /*if (player && playerIsVisible)
        {
            if (eyesAndEarTransform)
                ...
                Gizmos.DrawLine(charTargetTransform.position + new Vector3(0f, 1.6f, 0f), transform.position + new Vector3(0f, 1.6f, 0f));
        }*/
